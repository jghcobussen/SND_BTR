...
class DataPreprocess(object):
    ...
    def extract_showers(self, showers_data_root, E_TRHESHOLD=0.0001):
        ...
        #    print(TT_sim[0][13])
        #print("showers_mc: " + str(len(showers_mc)))
        #print(showers_mc)
    ...
    def clean_data_and_save(self, showers_data_root, save_folder, time_threshold=20, n_hits_threshold=1):
        ...
        #print("showers_sim:") ### seems empty
        #print(type(showers_sim))
        #print("showers_sim looks like:")
        #print(showers_sim)
        #print("showers_mc:")
        #print(showers_mc)
        #print("initial indeces:")
        #print(initial_indeces)
        MC_df = pd.DataFrame(showers_mc)
        TT_df = pd.DataFrame(showers_sim)
        #print("Shape of MC_df and TT_df is:")
        #print(MC_df.shape, TT_df.shape)
        #print("MC_df looks like:")
        #print(MC_df)     ###  is empty
        #print("TT_df looks like:")
        #print(TT_df)       ### is empty
        ...
        #print("now events will be filtered: ")
        ...
        #print("TT_df looks like: " + str(TT_df))
        MC_df = MC_df[n_hits > n_hits_threshold]
        #print("MC_df looks like: " + str(MC_df))
        #print(MC_df.shape)
        ...
        #print(nu_params)
        ###nu_params = pd.concat([nu_params, pd.get_dummies(nu_params['Label'], prefix='Label')], axis=1)
        ###nu_params.drop(['Label'], axis=1, inplace=True)
        #pd.set_option('display.max_rows', None)
        #print("Output of clean_and_save, namely nu_params and TT_df: ")
        #print("nu_params looks like:")
        #print(nu_params)
        #bisect_leftprint(list(TT_df.columns))
        #print("TT_df")
        #print(TT_df['X'])
