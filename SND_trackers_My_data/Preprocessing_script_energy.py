...
loc_of_pkl_file = "/dcache/bfys/jcobus/ship_tt_processed_data" 
...
file_size = 100000  # number of events to be analyse. Maximum number for DS5.root is 200'000
...
# results of step4
reduced_dimension = []
reduced_dimension.append(7.7114818514480118) # Reduced dimension for 3.5*stdev
reduced_dimension.append(7.985957990057633)  # Reduced dimension for 3.5*stdev
